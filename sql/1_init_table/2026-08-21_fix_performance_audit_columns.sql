...
SET @s = IF(
    EXISTS(SELECT 1 FROM information_schema.COLUMNS
             WHERE TABLE_SCHEMA = 'aio-life' AND TABLE_NAME = 'performance' AND COLUMN_NAME = 'create_by')
    AND NOT EXISTS(SELECT 1 FROM information_schema.COLUMNS
             WHERE TABLE_SCHEMA = 'aio-life' AND TABLE_NAME = 'performance' AND COLUMN_NAME = 'create_user'),
...
BEGIN
    ...
    DECLARE cur CURSOR FOR
        ...
        WHERE TABLE_SCHEMA = 'aio-life'
          AND TABLE_NAME NOT IN ('api_key_log', 'login_log', 'mail_log', 'enum_type')
          AND EXISTS (SELECT 1 FROM information_schema.COLUMNS c
                       WHERE c.TABLE_SCHEMA = 'aio-life' AND c.TABLE_NAME = information_schema.TABLES.TABLE_NAME
    ...
    read_loop: LOOP
        ...
        SET @s = IF(
            EXISTS(SELECT 1 FROM information_schema.COLUMNS
                     WHERE TABLE_SCHEMA = 'aio-life' AND TABLE_NAME = t AND COLUMN_NAME = 'create_user' AND IS_NULLABLE = 'NO'),
        ...
        SET @s = IF(
            EXISTS(SELECT 1 FROM information_schema.COLUMNS
                     WHERE TABLE_SCHEMA = 'aio-life' AND TABLE_NAME = t AND COLUMN_NAME = 'update_user' AND IS_NULLABLE = 'NO'),
